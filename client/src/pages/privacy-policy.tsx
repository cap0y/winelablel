      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="space-y-8 text-gray-300">
          <section>
            ...
            <p className="mb-4">
              (주)끄레망('끄레망 와인라벨')은 다음의 목적을 위하여 개인정보를 처리합니다. 
          ...
          <section>
            ...
            <p className="mb-4">
              ① (주)끄레망은 정보주체로부터 개인정보를 수집할 때 동의 받은 개인정보 보유·이용기간 
          ...
          <section>
            ...
            <p className="mb-4">
              ① (주)끄레망은 정보주체의 개인정보를 제1조(개인정보의 처리 목적)에서 명시한 범위 내에서만 처리하며, 
              정보주체의 동의, 법률의 특별한 규정 등 「개인정보 보호법」 제17조 및 제18조에 해당하는 경우에만 개인정보를 제3자에게 제공합니다.
            </p>
            <p>② (주)끄레망은 다음과 같이 개인정보를 제3자에게 제공하고 있습니다.</p>
          ...
          <section>
            ...
            <p className="mb-4">
              ① (주)끄레망은 원활한 개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고 있습니다.
            </p>
          ...
          <section>
            ...
            <p className="mb-4">
              ① 정보주체는 (주)끄레망에 대해 언제든지 다음 각 호의 개인정보 보호 관련 권리를 행사할 수 있습니다.
            </p>
            <ul className="list-disc list-inside space-y-2">
          ...
          <section>
            ...
            <p className="mb-4">
              (주)끄레망은 개인정보보호법 제29조에 따라 다음과 같이 안전성 확보에 필요한 기술적/관리적 및 물리적 조치를 하고 있습니다.
            </p>
            <ul className="list-disc list-inside space-y-2">
          ...
          <section>
            ...
            <p className="mb-4">
              ① (주)끄레망은 개인정보 처리에 관한 업무를 총괄해서 책임지고, 개인정보 처리와 관련한 정보주체의 불만처리 및 피해구제 등을 위하여 아래와 같이 개인정보 보호책임자를 지정하고 있습니다.
            </p>
            <div className="p-4 bg-gray-800 rounded-lg">
              ...
              <ul className="space-y-1">
                <li>성명: 김윤미</li>
                <li>직책: 대표이사</li>
                <li>연락처: 051.245.2983, info@cclemang.com</li>
              </ul>
            </div>
          </section>
