...
import { Wine, Type, ImageIcon, Grid, ShoppingCart, Save, Undo, Redo, Download, Palette, ArrowLeft, Upload } from "lucide-react";
            ...
            >
              <div className="text-center mb-2">
                <p className={`text-xs text-gray-300 bg-black/50 ${isMobile ? 'px-1 py-0.5' : 'px-2 py-1'} rounded`}>
                  실제 라벨 크기: {(labelWidth/2.54).toFixed(2)}cm × {(labelHeight/2.54).toFixed(2)}cm
                </p>
              </div>
          ...
          <Tabs defaultValue="template" className="w-full mt-2">
            ...
            <TabsContent value="template" className="space-y-3">
              ...
              <div>
                ...
                <div className="flex overflow-x-auto gap-2 pb-2"> {/* 수평 스크롤 */}
            ...
            <TabsContent value="text" className="space-y-6">
              ...
              <div>
                ...
                >
                  <SelectTrigger id="font-select" className="w-full bg-gray-800 border-gray-700 text-white">
            ...
            <TabsContent value="style" className="space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Card
                    className={`cursor-pointer transition-all p-3 flex justify-center items-center ${
