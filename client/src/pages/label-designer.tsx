        ...
        <Tabs defaultValue="template" className="w-full">
          ...
          <TabsContent value="text" className="space-y-6">
            ...
            <div className="space-y-4">
              <div>
                <Label htmlFor="main-text" className="text-white">
                  메인 텍스트
                </Label>
                <Input
                  id="main-text"
              ...
              <div>
                <Label htmlFor="sub-text" className="text-white">
                  부가 텍스트
                </Label>
                <Textarea
                  id="sub-text"
              ...
              <div className="space-y-4 pt-4">
                <div>
                  <div className="flex justify-between items-center mb-2">
                    <Label htmlFor="text-size" className="text-white">
                      메인 텍스트 크기: {labelDesign.textSize}rem
                    </Label>
                    <span className="text-xs text-gray-400">
                      {labelDesign.textSize < 1
                        ? "작게"
                        : labelDesign.textSize > 1.5
                          ? "크게"
                          : "보통"}
                    </span>
                  </div>
                ...
                <div>
                  <div className="flex justify-between items-center mb-2">
                    <Label htmlFor="subtext-size" className="text-white">
                      부가 텍스트 크기: {labelDesign.subtextSize}rem
                    </Label>
                    <span className="text-xs text-gray-400">
                      {labelDesign.subtextSize < 0.8
                        ? "작게"
                        : labelDesign.subtextSize > 1.2
                          ? "크게"
                          : "보통"}
                    </span>
                  </div>
            ...
            {/* 폰트 선택 */}
            <div>
              <Label htmlFor="font-select" className="block mb-2 text-white">
                폰트 스타일
              </Label>
              <Select
          ...
          <TabsContent value="style" className="space-y-6">
            ...
            {(() => {
              const selectedBorderOption = labelBorders.find(
                (b) => b.id === labelDesign.borderStyle,
              );
              return (
                selectedBorderOption?.type === "image" && (
                  <div className="mt-6">
          ...
          <TabsContent value="color" className="space-y-6">
            ...
            <div className="space-y-6">
              <div>
                <Label htmlFor="text-color" className="block mb-2 text-white">
                  텍스트 색상
                </Label>
              ...
              <div>
                <Label htmlFor="bg-color" className="block mb-2 text-white">
                  배경 색상
                </Label>
                <div className="flex items-center gap-4">
                  <input
