...
import { Wine, Globe, LogIn, User, LogOut, Bell, Truck, Package } from "lucide-react";
                        ...
                        <div className="flex items-start space-x-2 w-full">
                          ...
                          <div className="flex-1 min-w-0">
                            <div className="flex items-center space-x-2 mb-1">
                              <h4 className="font-medium text-gray-200 text-sm truncate">{notification.title}</h4>
                              {!notification.isRead && (
                                <span className="w-1.5 h-1.5 bg-blue-500 rounded-full flex-shrink-0"></span>
                              )}
                            </div>
                            <p className="text-gray-300 text-xs mb-1 line-clamp-2">{notification.message}</p>
